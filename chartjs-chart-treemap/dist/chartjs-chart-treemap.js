...
(function (global, factory) {
  ...
  function buildData(dataset, mainRect, captions) {
    ...
    const sp =
      helpers.valueOrDefault(dataset.spacing, 0) +
      helpers.valueOrDefault(dataset.borderWidth, 0);
    ...
    function recur(gidx, rect, parent, gs) {
      ...
      if (gidx < glen - 1) {
        gsq.forEach((sq) => {
          ...
          if (
            helpers.valueOrDefault(captions.display, true) &&
