...
!(function (t, e) {
  ...
  function s(t, e) {
    ...
    if (!i) return e;
    const r = o(t[0]);
    for (e = r ? e : "v", n = 0, i = t.length; n < i; ++n)
      r ? (t[n]._idx = n) : (t[n] = { v: t[n], _idx: n });
    return e;
  }
  function a(t, e) {
  ...
  function h(t, e) {
    const n = e.split(".");
    if (!t.split(".").reduce((t, e, i) => t && e <= n[i], !0))
      throw new Error(
        `Chart.js v${e} is not supported. v${t} or newer is required.`
      );
  }
  function u(t, e) {
  ...
  function c(t, e, n, i) {
    const r = t._normalized,
      ...
      s = Math.sqrt(r * o),
      a = r / s;
    return { d1: s, d2: a, w: "_ix" === i ? s : a, h: "_ix" === i ? a : s };
  }
  ...
  function p(t, e, n, i) {
    ...
    return (
      e.group && ((r.g = e.group), (r.l = e.level), (r.gs = e.groupSum)), r
    );
  }
  class g {
    constructor(t) {
      ...
      (t = t || { w: 1, h: 1 }),
        ...
        (e._ix = 0),
        (e._iy = 0),
        (e.w = t.w || t.width || t.right - t.left),
        (e.h = t.h || t.height || t.bottom - t.top);
    }
    get area() {
  ...
  function w(t, e, n) {
    ...
    const [i] = n,
      ...
      o = e.nsum * e.nsum,
      s = i * i,
      a = Math.max((s * t.nmax) / r, r / (s * t.nmin));
  ...
  function b(t, e, n, r, o, h) {
    ...
    for (m = 0; m < f; ++m)
      (y = {
        ...
        r && ((y.level = o), (y.group = b(m))),
        (y = d.pushIf(y, w, p)),
        y && (u.push(c.map(d)), (p = c.side), d.reset(), d.push(y));
    var _;
        ...
        ? r.captions &&
          ...
          (function (t, e, i) {
            ...
            (t.fillStyle = l),
              ...
              t.fillText(o.formatter || e.g, p, i.y + h + a + d.lineHeight / 2);
          })(t, i, e)
        : (function (t, e, i) {
            const r = i.options,
              o = r.labels;
            ...
            if (u) {
              const e = n.isArray(u) ? u : [u],
                a = (function (t, e, n, i) {
                  const r = t.labels,
                    o = t.borderWidth || 0,
                    { align: s, position: a, padding: l } = r;
                  let h, u;
                  (h = D(e, s, l, o)),
                    (u =
                      "top" === a
                        ? e.y + l + o
                        : "bottom" === a
                        ? e.y + e.height - l - o - (n.length - 1) * i
                        : e.y + e.height / 2 - (n.length * i) / 4);
                  return { x: h, y: u };
                })(r, i, e, h);
              (t.font = l.string),
                (t.textAlign = o.align),
                (t.textBaseline = o.position),
                (t.fillStyle = s),
                e.forEach((e, n) => t.fillText(e, a.x, a.y + n * h));
            }
          })(t, 0, e),
      t.restore();
  }
  function C(t, e) {
    ...
    if (
      (t.save(),
      (t.strokeStyle = n.lineColor || "black"),
      (t.lineCap = n.lineCapStyle),
      t.setLineDash(n.lineDash || []),
  ...
  class k extends e.DatasetController {
    ...
    update(t) {
      ...
      ("reset" !== t &&
        ((d = e._rect),
        (p = c),
        d && p && d.x === p.x && d.y === p.y && d.w === p.w && d.h === p.h) &&
        e._key === h &&
        !(function (t, e) {
          let n, i;
          if (t.lenght !== e.length) return !0;
          for (n = 0, i = t.length; n < i; ++n) if (t[n] !== e[n]) return !0;
          return !1;
        })(e._groups, s)) ||
        ((e._rect = c),
        (e._groups = s.slice()),
        ...
        (o.data = (function (t, e, i) {
          ...
          const a = t.groups || [],
            l = a.length,
            h =
              n.valueOrDefault(t.spacing, 0) +
              n.valueOrDefault(t.borderWidth, 0),
            u = i.font || {},
            c = n.toFont(u),
            d = n.valueOrDefault(i.padding, 3);
          return (
            !s.length && t.data.length && (s = t.tree = t.data),
            l
              ? (function t(e, u, p, g) {
                  const f = a[e],
                    m = e > 0 && a[e - 1],
                    ...
                    e < l - 1 &&
                      y.forEach((r) => {
                        (v = {
                          ...
                          n.valueOrDefault(i.display, !0) &&
                            _(r, c) &&
                            ((v.y += c.lineHeight + 2 * d),
                            (v.h -= c.lineHeight + 2 * d)),
                          x.push(...t(e + 1, v, r.g, r.s));
                      }),
                    x
                  );
                })(0, e)
    ...
    _drawDividers(t, e, n) {
      for (let i = 0, r = n.length; i < r; ++i) {
        const r = n[i],
          o = e[i];
        (r.options.dividers || {}).display &&
          o._data.children.length > 1 &&
          C(t, r);
      }
    }
    _drawRects(t, e, n, i) {
  ...
  function j(t, e) {
    ...
    return { left: n, top: i, right: n + r, bottom: i + o };
  }
  function E(t, e, n) {
        ...
        return (
          o(t)
            ? ((i = +t.top || 0),
              ...
              (a = +t.left || 0))
            : (i = r = s = a = +t || 0),
          { t: E(i, 0, n), r: E(r, 0, e), b: E(s, 0, n), l: E(a, 0, e) }
        );
  ...
  function M(t, e, n, i) {
    ...
    return (
      s &&
      (r || (e >= s.left && e <= s.right)) &&
      (o || (n >= s.top && n <= s.bottom))
    );
  }
  (k.id = "treemap"),
    (k.version = "2.0.2"),
    (k.defaults = {
      ...
      borderWidth: 0,
      spacing: 0.5,
      dividers: { display: !1, lineWidth: 1 },
    }),
    (k.descriptors = { _scriptable: !0, _indexable: !1 }),
    (k.overrides = {
      interaction: { mode: "point", intersect: !0 },
      hover: {},
      plugins: {
        tooltip: {
          position: "treemap",
      ...
      scales: {
        x: { type: "linear", display: !1 },
        y: { type: "linear", display: !1 },
      },
    }),
    ...
    (k.afterRegister = function () {
      ...
      t &&
        (t.positioners.treemap = function (t) {
  ...
  (P.id = "treemap"),
    ...
    (P.descriptors = { _scriptable: !0, _indexable: !1 }),
    (P.defaultRoutes = {
      backgroundColor: "backgroundColor",
      borderColor: "borderColor",
    }),
    e.Chart.register(k, P),
    (t.flatten = i),
    (t.group = r),
    (t.index = s),
    (t.isObject = o),
